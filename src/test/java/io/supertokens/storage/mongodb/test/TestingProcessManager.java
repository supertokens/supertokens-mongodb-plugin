...
class TestingProcessManager {
    ...
    public static abstract class TestingProcess extends Thread {
        ...
        io.supertokens.storage.mongodb.ProcessState.EventAndException checkOrWaitForEventInPlugin(
                io.supertokens.storage.mongodb.ProcessState.PROCESS_STATE state) throws InterruptedException {
        ...
        io.supertokens.storage.mongodb.ProcessState.EventAndException checkOrWaitForEventInPlugin(
            ...
            if (e == null) {
                ...
                while (e == null && (System.currentTimeMillis() - startTime) < timeToWaitMS) {
                    Thread.sleep(100);
                    e = io.supertokens.storage.mongodb.ProcessState.getInstance(start).getLastEventByName(state);
                }
            }
            return e;
        }
