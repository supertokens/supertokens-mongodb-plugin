...
public class MongoDBLoggingAppender implements Appender<ILoggingEvent> {

    static final String NAME = "io.supertokens.storage.mongodb.MongoDBLoggingAppender";

    private final Start start;

    private Context context;

    MongoDBLoggingAppender(Start start) {
        super();
        this.start = start;
    }
